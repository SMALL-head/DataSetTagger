...
public class UserInfoController {
    ...
    @RequestMapping(value = "/api/user/getId", produces = MediaType.APPLICATION_JSON_VALUE)
    public String getUserId() {
        return userService.getIdByUsername(SecurityContextHolder.getContext().getAuthentication().getName())+"";
    }
}
